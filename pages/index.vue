<template>
  <div>
    <Page title="Vorfälle" :nav-back="false">
      <template #end>
        <b-tooltip label="Personen" position="is-bottom">
          <div class="card-header-icon" @click="$router.push('/targets')">
            <b-icon icon="users" size="is-small" type="is-success" />
          </div>
        </b-tooltip>
        <b-tooltip label="Chats" position="is-bottom">
          <div class="card-header-icon mr-5" @click="$router.push('/chats')">
            <b-icon
              icon="whatsapp"
              pack="fa-brands"
              size="is-small"
